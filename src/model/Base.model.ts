...
export const HOMIE_TYPE_JSON = 'json';
...
export type HomieDatatype = typeof HOMIE_TYPE_INT | typeof HOMIE_TYPE_FLOAT | typeof HOMIE_TYPE_BOOL | typeof HOMIE_TYPE_STRING | typeof HOMIE_TYPE_ENUM | typeof HOMIE_TYPE_COLOR | typeof HOMIE_TYPE_DATETIME | typeof HOMIE_TYPE_DURATION | typeof HOMIE_TYPE_JSON;


export type HomieValuesTypes = string | number | boolean | Date | object | undefined | null;
...
export interface PropertyAttributesImpl extends BaseAttributesImpl {
    /** @description The data type. Any of the following values: "integer", "float", "boolean", "string", "enum", "color", "datetime", "duration", "json". */
